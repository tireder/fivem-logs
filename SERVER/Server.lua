...
AddEventHandler('DiscordBot:ToDiscord', function(WebHook, Name, Message, Image, External, Source, TTS)
	...
	if External then
		...
		elseif WebHook:lower() == 'banking' then
			WebHook = DiscordWebhookBank
		elseif WebHook:lower() == 'transfer' then
			WebHook = DiscordWebhookTransferi
		elseif WebHook:lower() == 'transferm' then
			WebHook = DiscordWebhookTransferm
		elseif WebHook:lower() == 'transferw' then
			WebHook = DiscordWebhookTransferw
               elseif WebHook:lower() == 'wash' then
			WebHook = DiscordWebhookWash
			elseif WebHook:lower() == 'rob' then
			WebHook = DiscordWebhookRob
			elseif WebHook:lower() == 'cars' then
				WebHook = DiscordWebhookCar
			elseif WebHook:lower() == 'anon' then
				WebHook = DiscordWebhookAnon
