...
Config.avatar = "logo here"				-- Bot Avatar
Config.communtiyName = "Community Name Here"					-- Icon top of the Embed
Config.communtiyLogo = "logo here"		-- Icon top of the Embed
...
-- Change color of the embeds here
...
Config.webhooks = {
  ...
  -- How you add more logs is explained on https://github.com/tireder/fivem_logs readme
  }


 --Debug 
Config.debug = false
Config.versionCheck = "2.2.0"
